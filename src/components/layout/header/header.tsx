...
const Header: React.FC<HeaderProps> = ({ menu }) => {
    ...
    useEffect(() => {
        if (needRefresh && window !== undefined) {
            refresh({
                variables: {
                    csrfToken:
                        (sessionStorage.getItem("csrfToken") as string) ||
    ...
    return (
        <header id="siteHeader" ref={siteHeaderRef} className="w-full h-16 sm:h-20 lg:h-24 z-20 font-text">
            <div
                style={bgImageStyle}
            ...
            >
                <div className="flex items-center justify-center mx-auto max-w-[1920px] h-full w-full">
                    ...
                    <HeaderMenu data={menu} className="hidden lg:flex md:ms-6 xl:ms-10" />
                    ...
                    <div className="header__input-container form-control w-full max-w-[1120px]">
                        ...
                        />
                        <button
                            className={`header__clear-button ${inputValue === "" ? false : true}`}
                    ...
                    <div className="hidden md:flex justify-end items-center space-s-6 lg:space-s-5 xl:space-s-8 2xl:space-s-10 ms-auto flex-shrink-0">
                        ...
                        <div className="-mt-0.5 flex-shrink-0">
                            <AuthMenu
                                ...
                                btnProps={{
                                    className: "text-sm xl:text-base text-base-100 font-semibold focus:outline-none",
